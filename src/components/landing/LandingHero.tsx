...
const LandingHero = () => {
  ...
  return <section className="relative min-h-[95vh] flex items-center overflow-hidden bg-gradient-to-br from-background via-primary/5 to-background">
      {/* Animated gradient orbs */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-primary/20 rounded-full blur-3xl animate-pulse" style={{
      ...
      <div className="absolute bottom-1/3 left-1/4 animate-[float_5s_ease-in-out_infinite]" style={{
      animationDelay: '1s'
    }}>
        <Zap className="w-6 h-6 text-accent/40" />
      </div>
      <div className="absolute top-1/2 right-1/3 animate-[float_7s_ease-in-out_infinite]" style={{
      animationDelay: '2s'
    }}>
      ...
      <div className="container relative z-10 px-4 mx-auto">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center space-y-8">
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-tight text-foreground animate-fade-in" style={{
            ...
            animationDelay: '200ms'
              ...
              {hooks.map((hook, index) => <div key={index} className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            animationDelay: '400ms'
              ...
              <Button size="lg" className="text-lg px-10 py-6 h-auto group hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl" onClick={handleGetStarted}>
                {user ? "Submit New Order" : "Launch LabLink Free"}
                <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Button>
              
              <Button size="lg" variant="outline" className="text-lg px-10 py-6 h-auto hover:scale-105 transition-all duration-300 border-2" onClick={() => window.location.href = "#how-it-works"}>
                See How It Works
              </Button>
            </div>
            
            <p className="text-xs text-muted-foreground animate-fade-in" style={{
            ...
            {/* Stats bar */}
            <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto pt-12 animate-fade-in" style={{
