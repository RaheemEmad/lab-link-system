      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-7xl mx-auto">
          {roles.map((role, index) => (
            <div
              key={role.type}
              className={`relative overflow-hidden rounded-2xl border border-border bg-gradient-to-br ${role.gradient} p-8 sm:p-10 animate-fade-in hover:shadow-xl transition-all duration-300`}
