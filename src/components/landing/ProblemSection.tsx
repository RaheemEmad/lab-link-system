...
const ProblemSection = () => {
  const problems = [
    ...
    },
    {
      ...
      description: "Each order handled differently — chaos",
    },
    {
      icon: AlertCircle,
  ...
  return (
    <section className="py-24 bg-secondary/30">
      <div className="container px-4 mx-auto">
        <h3 className="text-3xl md:text-4xl font-bold text-center mb-16 max-w-4xl mx-auto leading-tight">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {problems.map((problem, index) => (
            <div 
              key={index}
              className="bg-card p-8 rounded-xl shadow-[0_8px_30px_rgba(47,59,74,0.08)] hover:shadow-[0_12px_40px_rgba(47,59,74,0.12)] transition-all duration-200 hover:-translate-y-1 border border-border/50"
            >
