...
const FeatureSnapshot = () => {
  const features = [
    ...
    },
    {
      icon: TrendingUp,
      title: "Workflow",
      description: "Status updates from pending → delivered — visible to all",
    },
    {
      icon: Truck,
      title: "Delivery",
      description: "Add tracking numbers & target dates — reduce missed deliveries",
    },
    {
      icon: Search,
      title: "Search",
      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="bg-card p-6 rounded-xl border border-border hover:border-primary/50 transition-all duration-200 hover:shadow-[0_8px_30px_rgba(47,59,74,0.08)]"
            >
