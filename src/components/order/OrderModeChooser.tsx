...
const modes = [
  {
    ...
    description: "Submit a complete case to your preferred lab or invite labs to review and bid on your order.",
    badge: null,
  },
  {
  ...
  },
  {
    ...
    icon: BookTemplate,
    title: "From Template",
    description: "Re-use a saved case template to quickly place a repeat order with your lab.",
    badge: null,
  },
];
