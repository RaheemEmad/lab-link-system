...
const LabCalendar = () => {
  ...
  // Fetch orders for this lab within date range
          ...
          <div className="container px-3 sm:px-4 lg:px-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
              <div>
                ...
                <p className="text-muted-foreground text-sm mt-1">
                  Order deadlines and delivery schedule
                </p>
              </div>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <Badge variant="outline" className="gap-1.5">
                <span className="h-2 w-2 rounded-full bg-destructive" /> Overdue / Urgent
              </Badge>
              <Badge variant="outline" className="gap-1.5">
                <span className="h-2 w-2 rounded-full bg-orange-500" /> Due Today
              </Badge>
              <Badge variant="outline" className="gap-1.5">
                <span className="h-2 w-2 rounded-full bg-primary" /> On Track
              </Badge>
              <Badge variant="outline" className="gap-1.5">
                <span className="h-2 w-2 rounded-full bg-muted-foreground/40" /> Delivered
              </Badge>
            </div>
