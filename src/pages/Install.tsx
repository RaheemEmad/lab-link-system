...
const Install = () => {
  ...
  const features = [
    { icon: WifiOff, title: "Offline Access", description: "Work seamlessly even without internet connection" },
    { icon: Zap, title: "Lightning Fast", description: "Instant loading with cached content" },
    { icon: Bell, title: "Push Notifications", description: "Stay updated with order status changes" },
    { icon: Smartphone, title: "Native Experience", description: "Feels like a real app on your device" },
  ];
      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-muted flex items-center justify-center p-4">
        <Card className="max-w-md w-full">
          <CardHeader className="text-center">
            ...
            <CardDescription>LabLink is already installed on your device</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-center text-muted-foreground">You can access LabLink from your home screen anytime.</p>
      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-4">Install LabLink</h1>
